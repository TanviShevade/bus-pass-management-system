...
<body>
    <div class="container mt-5">
        <h2 class="text-center text-" style="color: indianred;">Reset Your Password</h2>
        <form method="POST" class="shadow p-4 bg-white">
            ...
            <button type="submit" class="btn btn- w-100" style="background-color: indianred;color: white;">Reset Password</button>
        </form>
    </div>
</body>
</html>
